...
public class CompletedActivityResource {
	...
	public ResponseEntity<CompletedActivityDTO> createCompletedActivity(
			@RequestBody CompletedActivityDTO completedActivityDTO) throws URISyntaxException {
	 ...
	 *         completedActivityDTO, or with status 400 (Bad Request) if the
	 *         completedActivityDTO is not valid, or with status 500 (Internal
	 *         Server Error) if the completedActivityDTO couldn't be updated
	 * @throws URISyntaxException if the Location URI syntax is incorrect
	 */
	@PutMapping("/completed-activities")
	@Timed
	public ResponseEntity<CompletedActivityDTO> updateCompletedActivity(
			@RequestBody CompletedActivityDTO completedActivityDTO) throws URISyntaxException {
