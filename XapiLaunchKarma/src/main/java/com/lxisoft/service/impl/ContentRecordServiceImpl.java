...
public class ContentRecordServiceImpl implements ContentRecordService {
    ...
    public ContentRecordServiceImpl(ContentRecordRepository contentRecordRepository, ContentRecordMapper contentRecordMapper) {
    ...
    public Page<ContentRecordDTO> findAll(Pageable pageable) {
        ...
        return contentRecordRepository.findAll(pageable)
            .map(contentRecordMapper::toDto);
    }
    ...
    public Optional<ContentRecordDTO> findOne(String id) {
        ...
        return contentRecordRepository.findById(id)
            .map(contentRecordMapper::toDto);
    }
