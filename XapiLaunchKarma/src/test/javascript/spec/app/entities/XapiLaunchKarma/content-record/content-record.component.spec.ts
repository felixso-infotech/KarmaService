...
import { ContentRecordComponent } from 'app/entities/XapiLaunchKarma/content-record/content-record.component';
...
describe('Component Tests', () => {
  describe('ContentRecord Management Component', () => {
    let comp: ContentRecordComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContentRecordComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contentRecords[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
