...
import { CompletedChallengeComponent } from 'app/entities/Karma/completed-challenge/completed-challenge.component';
...
describe('Component Tests', () => {
  describe('CompletedChallenge Management Component', () => {
    let comp: CompletedChallengeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CompletedChallengeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new CompletedChallenge(123)],
            headers
          })
        )
      );
      ...
      expect(comp.completedChallenges[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
