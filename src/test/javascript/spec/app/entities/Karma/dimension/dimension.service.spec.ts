...
import { DimensionService } from 'app/entities/Karma/dimension/dimension.service';
import { IDimension, Dimension } from 'app/shared/model/Karma/dimension.model';
...
describe('Service Tests', () => {
  describe('Dimension Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Dimension(0, 'AAAAAAA');
    });
