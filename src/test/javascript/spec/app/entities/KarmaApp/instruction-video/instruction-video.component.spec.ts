...
import { InstructionVideoComponent } from 'app/entities/KarmaApp/instruction-video/instruction-video.component';
...
describe('Component Tests', () => {
  describe('InstructionVideo Management Component', () => {
    let comp: InstructionVideoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InstructionVideoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.instructionVideos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
