...
import { MediaUpdateComponent } from 'app/entities/KarmaApp/media/media-update.component';
import { MediaService } from 'app/entities/KarmaApp/media/media.service';
import { Media } from 'app/shared/model/KarmaApp/media.model';
